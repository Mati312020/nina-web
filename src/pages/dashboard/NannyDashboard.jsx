        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="bg-white border-b border-gray-100">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
                    ...
                    {/* Fila principal: saludo + controles */}
                    <div className="flex items-center justify-between gap-2">
                        ...
                        <div className="flex items-center gap-2 flex-shrink-0">
                            {/* Billetera + Facturas: solo desktop */}
                            ...
                            <Button onClick={() => setShowAvailModal(true)} className="gap-1.5 text-sm whitespace-nowrap">
                                <Plus size={16} />
                    ...
                    {/* Fila secundaria: Billetera + Facturas solo en mobile */}
                ...
                <section>
                    <Carousel title="Vacantes Disponibles">
                        {loadingVacancies ? (
                            ...
                            sortByProximity(vacancies, profile?.locality, profile?.province, 'family_locality', 'family_province')
                                .map((vacancy) => (
                                    <FamilyVacancyCard
                                        key={vacancy.id}
                                        vacancy={vacancy}
                                        ...
                                        proximityLabel={getProximityLabel(vacancy, profile?.locality, profile?.province, 'family_locality', 'family_province')}
                                    />
                                ))
                        )}
                    </Carousel>
