...
export const LoginPage = () => {
    ...
    // Redirigir al dashboard correcto cuando el perfil se cargue post-login
    useEffect(() => {
        if (profile?.role) {
    ...
    const handleForgotPassword = async (e) => {
        ...
        try {
            ...
            setError('No pudimos enviar el email. Revisá la dirección ingresada.');
        } finally {
        ...
        <div className="min-h-[80vh] flex items-center justify-center p-4 bg-gray-50">
            <Card className="w-full max-w-md p-8 border-none shadow-xl">
                ...
                <div className="text-center mb-8">
                    ...
                    {forgotMode ? (
                        <>
                            <h2 className="text-2xl font-bold text-gray-900 font-poppins">Recuperar contraseña</h2>
                    ...
                    forgotSent ? (
                        <div className="text-center space-y-4">
                            <div className="bg-green-50 border border-green-200 rounded-xl p-4">
                                <p className="text-sm text-green-700 font-nunito font-medium">
                                    ¡Listo! Revisá tu bandeja de entrada (y spam) en <strong>{forgotEmail}</strong>.
                                </p>
                                <p className="text-xs text-green-600 font-nunito mt-1">
